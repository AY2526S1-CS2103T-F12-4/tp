...
CLInic data are saved automatically as a JSON file `[JAR file location]/data/adressbook.json`. Advanced users are welcome to update data directly by editing that data file.
